...
class Organizacao (models.Model):
    ...
    ramo = models.ForeignKey(Ramo, related_name='orgs',
    ...
    erpe = models.ForeignKey(Erp, related_name='orgs',
                             blank=True, null=True, on_delete=models.CASCADE)
    contatos = models.ManyToManyField(Cliente, related_name='orgs', blank=True)
    created = models.ForeignKey(
        Created, on_delete=models.CASCADE, null=True, blank=True)
    updated = models.ManyToManyField(Updated)
...
class Atividade (models.Model):
    ...
    ticket = models.ForeignKey(
        Ticket, related_name='atividades', on_delete=models.CASCADE, null=True)
    cliente = models.ForeignKey(Cliente, on_delete=models.CASCADE, null=True)
    org = models.ForeignKey(Organizacao, on_delete=models.CASCADE, null=True)
